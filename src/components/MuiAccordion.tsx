  ...
  return (
    <div>
        <Accordion expanded={expanded === 'panel1'} onChange={(event,isExpanded) => handleChange(isExpanded,'panel1')}>
            ...
            <AccordionDetails> 
                <Typography>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi voluptas quibusdam quasi? Porro quae id ullam quis, 
                    neque exercitationem perferendis ab vero earum libero iusto omnis pariatur dolore nihil fuga.
                </Typography>
            </AccordionDetails>
        </Accordion>
